    ...
    public Flux<Map<String, Object>> simulateOrderFlowWithRecovery() {
        ...
        return Flux.range(1, 10)
                ...
                .flatMap(id -> {
                    ...
                    // Simulación de error operativo real
                    if (amount > 25) {
                        return Mono.error(new RuntimeException(
                                "Pedido #" + id + " rechazado por política de riesgo"
                        ));
                    }
                ...
                // Recuperación por evento (NO se rompe el stream)
                .onErrorContinue((error, obj) -> {
                    System.out.println(" Evento fallido controlado: " + error.getMessage());
                })
                ...
                // Logging reactivo
                .doOnSubscribe(s -> System.out.println(" Flujo reactivo iniciado"))
                .doOnNext(e -> System.out.println(" Evento procesado: " + e))
                .doOnComplete(() -> System.out.println(" Flujo reactivo finalizado correctamente"));
    }
}