...
/*
 * 
 * Este fragmento implementa el patrón Publisher usando Project Reactor (Flux)
 * para simular flujos de datos de productos, pedidos y montos del carrito en
 * una tienda online.
 * 
 * Se aplican transformaciones como filter (para filtrar productos disponibles y
 * pedidos válidos) y map (para calcular precios con IVA), modelando la lógica
 * de negocio real.
 * 
 * El uso de delayElements simula asincronía, representando el procesamiento no
 * bloqueante típico de sistemas reactivos modernos.
 * 
 * Esta implementación permite transformar y procesar eventos del dominio de
 * manera eficiente y declarativa, cumpliendo con los principios de la
